      ...
      <div class="col-lg-9">
        <div class="main_content">
          ...
          <div class="blog_section">
            <div
              class="section_panel d-flex flex-row align-items-center
            ...
            <div class="section_content">
              <div class="grid clearfix">
                  ...
                  <div class="card card_largest_with_image grid-item">
                    ...
                    <div class="card-body">
                      ...
                      <small class="post_meta">
                        <a href="blog/{post.slug}">{post.author}</a>
                        <span>
                ...
                {#each otherPosts as post}
                  <div
                    class="card card_default card_small_with_image grid-item">
                ...
                <div class="custom_nav_container sidebar_slider_nav_container">
                  <div class="custom_prev custom_prev_top">
                    <svg
                      ...
                      <polyline
                        fill="#bebebe"
                        points="0,5.61 5.609,0 7,0 7,1.438 2.438,6 7,10.563 7,12
                        5.609,12 -0.002,6.39 " />
                    </svg>
                  </div>
                  ...
                  <div class="custom_next custom_next_top">
                    <svg
                      ...
                      <polyline
                        fill="#bebebe"
                        points="6.998,6.39 1.389,12 -0.002,12 -0.002,10.562
                        4.561,6 -0.002,1.438 -0.002,0 1.389,0 7,5.61 " />
                    </svg>
                  </div>
                </div>
              </div>
                    ...
                    {#each posts as post}
                      <div class="side_post">
                        <a href="blog/{post.slug}.html">
                          <div
                            class="d-flex flex-row align-items-xl-center
                            align-items-start justify-content-start">
                            <div class="side_post_image">
                              <div>
                                <img src={post.imageBackdrop.url} alt="" />
                              </div>
                            </div>
